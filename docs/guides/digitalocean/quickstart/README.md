...
url: /docs/{{ .version }}/guides/digitalocean/quickstart/
aliases:
  - /docs/{{ .version }}/guides/digitalocean/quickstart/README/
---
...
Follow this guide for more information [here](/docs/guides/digitalocean/credentials/)
