...
url: /docs/{{ .version }}/guides/azure/quickstart/
aliases:
  - /docs/{{ .version }}/guides/azure/quickstart/README/
---
...
Follow this guide for more information [here](/docs/guides/azure/credentials/)
